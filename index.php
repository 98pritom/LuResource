        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div>
                    ...
                    <div class="col d-flex justify-content-center mb-5 mt-3">
                        <div class="card">
                            <img src="images/login-banner.jpg" class="img-fluid h-100" alt="...">
                        </div>
                    </div>
                </div>
