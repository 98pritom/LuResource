...
<div class="section-header">
	...
	<p class="p-header1">At home in the office or on the go, LUResource keeps your personal and busines files</p>
...
<div class="container">
	...
	<div class="row mt-4">
		<div class="col-md-6 col-xs-12">
			<div class="card">
				<img class="card-img-top" src="storage/Ragib.jpg" alt="">
				<div class="card-body">
		...
		<div class="col-md-6 col-xs-12">
			<div class="card">
				<img class="card-img-top" src="storage/kazi.png" alt="">
				<div class="card-body">
